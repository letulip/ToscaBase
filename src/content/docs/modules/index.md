...
| [Control identification](/ToscaBase/modules/control-identification/) | Identify by properties, anchor, image and index, in that order, wildcards for dynamic values, and `ExplicitName` for choosing a control from the TestCase |
...
| [Control groups](/ToscaBase/modules/control-groups/) | Group related ModuleAttributes under one node in XScan, and split the group again |
