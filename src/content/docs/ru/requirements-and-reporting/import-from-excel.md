...
3. Правой кнопкой по папке **> Create Folder Structure**; в уроке для этого действия также названы горячие клавиши Ctrl+N и Ctrl+S. Commander строит дерево из скопированных ячеек.
