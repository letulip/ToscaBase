...
:::tip
Изменили TestCase после добавления в ExecutionList? Щёлкните правой кнопкой по ExecutionList и выберите **Synchronize**, чтобы запись отражала изменения до запуска.
:::
