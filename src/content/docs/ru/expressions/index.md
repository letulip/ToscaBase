...
- [Строковые операции](/ToscaBase/ru/expressions/string-operations/) — `STRINGLENGTH`, `STRINGTOUPPER`/`STRINGTOLOWER`, `NUMBEROFOCCURRENCES`, `TRIM`, `STRINGREPLACE` с экранированием символов, `BASE64` для кодирования и декодирования и `MATH`.
