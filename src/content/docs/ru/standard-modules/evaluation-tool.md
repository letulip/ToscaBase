...
:::note
Оператор и математическое выражение видны только на экране: автор говорит «equals» (`==`, как записано в Lesson 16) и «the math expression» с двумя буферами внутри. Синтаксис математического выражения описан в [Интервалы и выражения проверки](/ToscaBase/ru/expressions/intervals-and-verification-expressions/).
:::
