...
:::note
Запрос только проговаривается («vehicle, квадратная скобка, make равно равно BMW», в задаче find Expert Module); нужны ли кавычки вокруг значения, не сказано. Попробуйте оба варианта.
:::
