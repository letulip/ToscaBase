...
| [Препятствия: ввод и клики](/ToscaBase/ru/troubleshooting/obstacles-input-and-clicks/) | `{DRAG}` / `{DROP}`, клики до смены подписи (`While`), экранирование значений, `{CLICK}` с `OffsetHorizontal`, модуль *Click On Screen*. |
