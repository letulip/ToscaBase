...
:::note
Автор называет `*` регулярным выражением; в значениях свойств Tosca это подстановочный знак. Полноценные регулярные выражения описаны в [Интервалах и выражениях верификации](/ToscaBase/ru/expressions/intervals-and-verification-expressions/).
:::
