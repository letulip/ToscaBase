...
| [Идентификация контролов](/ToscaBase/ru/modules/control-identification/) | Identify by properties, anchor, image и index — именно в этом порядке, — подстановочные знаки для динамических значений и `ExplicitName` для выбора контрола из TestCase |
...
| [Группы контролов](/ToscaBase/ru/modules/control-groups/) | Объединение связанных ModuleAttribute под одним узлом в XScan и обратное разделение группы |
