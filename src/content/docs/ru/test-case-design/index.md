...
Читайте по порядку. Обзор даёт словарь, следующие два документа строят лист, документ о шаблонах превращает его в TestCase, классы убирают дублирование между листами, а разбор связывает всё вместе. См. также [Структура тест-кейса](/ToscaBase/ru/best-practices/test-case-structure/) — правило «без констант», на которое опираются шаблоны, и [Требования и риски](/ToscaBase/ru/requirements-and-reporting/requirements-and-risk/) — привязка сгенерированных TestCase к требованиям.
