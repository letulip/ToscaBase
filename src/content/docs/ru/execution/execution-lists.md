...
| Нужен ли check-out (взятие на редактирование) | Нет | Да, ExecutionList должен быть взят на check-out |
