...
:::tip
Синхронизация нужна только если вы продолжаете перестраивать TestCase после создания ExecutionList. Если список создан после окончания разработки и дальше правятся только TestStep, она не понадобится никогда.
:::
