...
| [TestCase для API](/ToscaBase/ru/api-testing/api-test-cases/) | Экспорт сообщений, Module запроса и ответа, Technical view, ModuleAttribute, верификация кодов состояния и полей payload, буферизация значений для цепочки запросов, ExecutionList |
