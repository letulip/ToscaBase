...
description: Многопользовательские workspace на общем репозитории, пользователи и группы, ветки, резервное копирование и версионирование, test mandate, инструменты командной строки и Tosca Server.
level: 4
sidebar:
  order: 0
---
...
| [Test mandate](/ToscaBase/ru/administration/test-mandates/) | Выполнение одного ExecutionList несколькими пользователями без перезаписи результатов |
...
**Synchronization policy** (политика синхронизации) репозитория — самый частый источник вопросов «почему я не могу взять эту папку на check-out» — объяснена в [Синхронизация вместо ожиданий](/ToscaBase/ru/best-practices/synchronisation-not-waits/).
